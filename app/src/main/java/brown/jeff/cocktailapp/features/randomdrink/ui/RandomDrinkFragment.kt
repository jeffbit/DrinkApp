package brown.jeff.cocktailapp.features.randomdrink.ui
...
import brown.jeff.cocktailapp.ui.random.RandomDrinkFragmentDirections
...
class RandomDrinkFragment : Fragment() {
    ...
    private var drink: RandomDrinkDetailModel? = null
...
//    }
    ...
    private fun favoriteFloatingActionButton(view: View, drink: RandomDrinkDetailModel) {
...
// todo: need to setup
//    private fun addDrinkToFavorites(view: View, drink: RandomDrinkDetailModel) {
//
...
//        ) { randomDrinkViewModel.removeDrinkFromFavorites(drink.id) }
//
//    }
