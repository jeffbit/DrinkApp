package brown.jeff.cocktailapp.features.favoritedrink.ui
...
import brown.jeff.cocktailapp.features.favoritedrink.ui.adapter.FavoriteDrinkListAdapter
...
class FavoriteDrinksFragment : Fragment(R.layout.fragment_favorites) {
    ...
    private lateinit var favoriteDrinkAdapter: FavoriteDrinkListAdapter
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        favoriteDrinkAdapter = FavoriteDrinkListAdapter(
            emptyList()
        ...
        favoriteDrinkAdapter.drinkSelectedListener =
            object : FavoriteDrinkListAdapter.DrinkSelectedListener {
                override fun onDrinkSelected(drink: DrinkFavoriteListModel, imageView: ImageView) {
                    val extras = FragmentNavigatorExtras(imageView to drink.imgURL)
                }
            }
