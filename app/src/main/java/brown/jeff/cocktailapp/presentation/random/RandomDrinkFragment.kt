...
class RandomDrinkFragment : Fragment() {
    ...
    private var drinkEntity: DrinkEntity? = null
    ...
    override fun onResume() {
        super.onResume()
        randomDrinkViewModel.drinkEntity.observe(viewLifecycleOwner, Observer {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.drinkclicked_favorite_menuitem -> {
                addDrinkToFavorites(this.requireView(), drinkEntity!!)
                true
            }
    ...
    private fun favoriteFloatingActionButton(view: View, drinkEntity: DrinkEntity) {
        favoritedrink_fab.setOnClickListener {
            addDrinkToFavorites(view, drinkEntity)
        }

    }

    private fun addDrinkToFavorites(view: View, drinkEntity: DrinkEntity) {

        randomDrinkViewModel.addDrinkToFavorites(drinkEntity)
        showSnackBar(
            view,
            getString(R.string.drink_added_to_favorites),
            Snackbar.LENGTH_LONG,
            getString(R.string.undo)
        ) { randomDrinkViewModel.removeDrinkFromFavorites(drinkEntity.idDrink) }
